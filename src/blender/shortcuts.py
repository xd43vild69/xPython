...
[("3D View",
  ...
  {"items":
   [("qremesher.remesh", {"type": 'R', "value": 'PRESS', "ctrl": True, "alt": True}, None),
    ...
    ("view3d.localview", {"type": 'H', "value": 'PRESS', "ctrl": True, "alt": True}, None),
 ...
 ("Sculpt",
  ...
  {"items":
   [("sculpt.brush_stroke",
    ...
    ("ed.undo", {"type": 'NUMPAD_0', "value": 'PRESS'}, None),
    ("ed.redo", {"type": 'NUMPAD_PERIOD', "value": 'PRESS'}, None),
    ("wm.radial_control",
     {"type": 'NUMPAD_1', "value": 'PRESS'},
     {"properties":
      [("data_path_primary", 'tool_settings.sculpt.brush.size'),
 ...
 ("Window",
  ...
  {"items":
   [("wm.call_menu",
    ...
    ("wm.obj_import", {"type": 'I', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True}, None),
    ],
   },
  ),
 ]
