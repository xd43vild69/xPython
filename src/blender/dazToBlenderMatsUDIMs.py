...
class MainPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = layout.row()
        row.operator("wm.base", icon='MESH_MONKEY', text="Base_G8F")
        row = layout.row()
        row.operator("wm.muscle", icon='MESH_MONKEY', text="Muscle_G8F")
        row = layout.row()
        row.operator("wm.clay", icon='MESH_MONKEY', text="Clay_G8F")        
        row = layout.row()
